          ...
          <h6 className="pt-3 pb-5">
            <div className="row">
              ...
              <div className="col-8 fw-bold px-5">
                ...
                <p className="fs-6" style={{ lineHeight: "2" }}>Sau từ 1 tới 5 ngày, nhân viên dịch vụ chuyển phát nhanh sẽ giao hàng tại địa chỉ mà Quý khách đã đăng ký. Shop đề nghị Quý khách quay video đồng kiểm khi nhận hàng có kèm hình ảnh của nhân viên giao nhận, sau đó thực hiện kiểm tra máy và thanh toán số tiền còn thiếu nếu máy đúng như mô tả (Căn cứ vào hình thức mô tả và ảnh chụp được gửi cho Quý khách trước đó).</p>
              </div>
            </div>
          </h6>
        </div>
